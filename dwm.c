...
buttonpress(XEvent *e)
{
	...
	if (ev->window == selmon->barwin) {
		...
		/* else if (ev->x > selmon->ww - (int)TEXTW(stext)  - statusw + lrpad - 2 - getsystraywidth()){ */
		else if (ev->x > selmon->ww  - statusw + lrpad - 2 - getsystraywidth()){ //modify
			x = selmon->ww - statusw -getsystraywidth();  //modify
